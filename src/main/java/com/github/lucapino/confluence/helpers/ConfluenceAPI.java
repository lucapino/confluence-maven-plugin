...
/**
 * Specifies the API paths that are so far supported with this confluence
 * client.
 *
...
public interface ConfluenceAPI {
    ...
    /**
     * Fetch the children for a given {@code Content} identified by the
     * {@code parentId}.
     *
     ...
     *
     * @return a list of all child content, matching {@code params} and
     *         {@code parentId}.
     */
    ...
    Call<Content> getContentById(final @Path("id") String id);
     ...
     * POST Content.
     *
     * @param content the piece of {@code Content} to be included in the body of
     *                the request.
     *
    ...
    /**
     * Same as {@link #postContent} but clients can provide a callback with
     * success
     * and failure hooks.
     *
     * @param content  the piece of Content to be included in the body of the
     *                 request.
     ...
     * <ul>
     * <li>If the content is trashable and its status is
     * {@literal ContentStatus#CURRENT}, it will be trashed.</li>
     * <li>If the content is trashable, its status is
     * {@literal ContentStatus#TRASHED} and the "status" query parameter in
     * the request is "trashed", the content will be purged from the trash and
     * deleted permanently.</li>
     * <li>If the content is not trashable it will be deleted permanently
     * without being trashed.</li>
     * </ul>
     *
     * @param id the id of the page of blog post to be deleted.
     *
     * @return a reference to the message holder, indicating the status of the
     *         request.
     */
    ...
    Call<ContentResultList> getAllSpaceContent(final @Path("spaceKey") String spaceKey,
            final @QueryMap Map<String, String> params);
     ...
     *
     * @return a wrapper model around the {@link ContentResultList} resulting
     *         from this call.
     */
    @GET("rest/api/space/{spaceKey}/content/{type}")
    Call<ContentResultList> getRootContentBySpaceKey(final @Path("spaceKey") String spaceKey,
