...
public interface QueryParams {
    ...
    /**
     * Enumerated list of statuses the content to be found is in.
     * Defaults to {@code CURRENT} if not specified. If set to {@code ANY},
     * content in {@code CURRENT} and {@code TRASHED} status will be fetched.
     */
    enum Status {
        ALL,
        CURRENT,
