 ...
 * @see
 * <a href="https://confluence.atlassian.com/display/DOC/JIRA+Issues+Macro">JIRA
 * Issues Macro</a>
 */
public class JiraIssuesMacro {
    ...
    public enum Parameters {
        /**
         * If this parameter is set to 'true', JIRA will return only the issues
         * which allow
         * unrestricted viewing. That is, the issues which are visible to
         * anonymous viewers,
         * as determined by JIRA's viewing restrictions. If this parameter is
         * omitted or set
         * to 'false', then the results depend on how your administrator has
         * configured the
         * communication between JIRA and Confluence. By default, Confluence
         * will show only
         ...
         * your JIRA site,
         * will use this base URL instead of the value of the 'url' parameter.
         * This is useful
         * when Confluence connects to JIRA with a different URL from the one
         * used by other users.
         */
        BASEURL,
        /**
        ...
        COLUMNS,
        /**
         * If this parameter is set to 'true', the issue list will show the
         * number of issues in
         * JIRA. The count will be linked to your JIRA site.
         */
        COUNT,
        /**
         * The macro maintains a cache of the issues which result from the JIRA
         * query. If the 'cache'
         * parameter is set to 'off', the relevant part of the cache is cleared
         * each time the macro
         * is reloaded. (The value 'false' also works and has the same effect as
         * 'off'.)
         */
        CACHE,
        /**
         ...
         * situations:
         * <ul>
         * <li>If the 'renderMode' parameter (see below) is set to
         * 'static'.</li>
         * <li>When the JIRA issues are displayed in a PDF or Word document, in
         * an email message
        ...
        HEIGHT,
        /**
         * If the value is 'dynamic', the JIRA Issues macro offers an
         * interactive display which
        ...
        RENDER_MODE,
        /**
         * You can customise the title text at the top of the JIRA issues table
         * with this
         * parameter. For instance, setting the title to 'Bugs-to-fix' will
         * replace the
         * default 'JIRA Issues' text. This can help provide more context to the
         * list of
         * issues displayed.
         */
        TITLE,
        /**
         * The URL of the XML view of your selected issues in JIRA Issue
         * Navigator.
         * <p>
         * For example:
         * <pre>{@literal
        ...
        URL,
        /**
         * The width of the table displaying the JIRA issues. Can be indicated
         * either as
     ...
     * Constructor
     *
     * @param builder the builder factory used to build this
     *                {@code JiraIssuesMacro}
     */
    ...
    public static class Builder {
        ...
        /**
         * @param count predicate for enabling the number of issues to be
         *              displayed.
         *
         * @return {@code this}.
         *
